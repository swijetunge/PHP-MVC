     ...
     <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2396.5486962319114!2d-2.4014889999999993!3d53.08238!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xca1350f57cb4338c!2sTeam+Rewards!5e0!3m2!1sen!2suk!4v1403257499198"></iframe>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
		  ...
		  <a name="submit"></a>	<br />
			...
			?>
            <form role="form" method="POST" action="contactus#submit">
	            <div class="row">
	              <div class="form-group col-lg-4">
	                <label for="input1">Name</label>
	                <input type="text" name="name" class="form-control" id="input1" value="<?php if(isset($this->name)) echo $this->name; ?>">
	              </div>
	              <div class="form-group col-lg-4">
	                <label for="input2">Email Address</label>
	                <input type="email" name="email" class="form-control" id="input2" value="<?php if(isset($this->email)) echo $this->email; ?>">
	              </div>
	              <div class="form-group col-lg-4">
	                <label for="input3">Phone Number</label>
	                <input type="phone" name="phone" class="form-control" id="input3" value="<?php if(isset($this->phone)) echo $this->phone; ?>">
	              </div>
	              <div class="clearfix"></div>
	              <div class="form-group col-lg-12">
	                <label for="input4">Message</label>
	                <textarea name="message" class="form-control" id="input4"><?php if(isset($this->message)) echo $this->message; ?></textarea>
	              </div>
	              <div class="form-group col-lg-12">
