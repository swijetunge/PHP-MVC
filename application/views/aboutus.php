<?php include_once($_SERVER['DOCUMENT_ROOT'].'/application/views/includes/header.php'); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
	            <div class="embed-container">
	                <iframe src="//player.vimeo.com/video/55169240?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
	            </div>
    ...
    <div class="section section-colored-white">
        ...
        <div class="container">
	        ...
	        <div class="row">
				...
				<div class="recommended_items"><!--recommended_items-->
					<h2 class="page-header text-center">Our Customers</h2>
